...
import course_manage1 from '@/module/course/page/course_manage/course_manage.vue';
export default [
  {
    path: '/course',
    component: Home,
    ...
    children: [
      ...
      { path: '/course/manager/:courseid', name: '管理课程',component: course_manage,hidden: true ,
        children: [
          ...
          { path: '/course/manage/manage/:courseid', name: '管理课程',component: course_manage1,hidden: false},
